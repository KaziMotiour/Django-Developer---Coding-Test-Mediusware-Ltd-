...
export default function Singup() {
  ...
  const registrationError = useSelector(
    (state) => state.auth.registration_error
  );
  const regConfirmation = useSelector(
    (state) => state.auth.registration_confirmation
  );
  ...
  return (
    <div className='login'>
      ...
      <div className='login-body'>
        <div className='logo'>
          <img
            src='https://icdn2.digitaltrends.com/image/digitaltrends/social-media-history-large-header-768x768.png'
            alt='Italian Trulli'
          />
        </div>
        <div className='form'>
            ...
            <div className={classes.paper}>
              ...
              <form className={classes.form} noValidate>
                ...
                <TextField
                  ...
                  onChange={(e) => HandleInput(e)}
                />
                {registrationError && registrationError.username && (
                  <span style={{ color: "red" }}>
                ...
                <TextField
                  ...
                  onChange={(e) => HandleInput(e)}
                />
                {registrationError && registrationError.password1 && (
                  <span style={{ color: "red" }}>
                    {registrationError.password1}
                  </span>
                )}
                <TextField
                  variant='outlined'
                  ...
                  onChange={(e) => HandleInput(e)}
                />
                {registrationError && registrationError.password2 && (
                  <span style={{ color: "red" }}>
                    {registrationError.password2}
                  </span>
                )}
                <br />
                <FormControlLabel
